...
export async function updateStats(data: FormData, token: string) {
  const url = `${dashboardBaseServerUrl}${adminServerUrls.editStats}`; // Adjust based on your update endpoint
