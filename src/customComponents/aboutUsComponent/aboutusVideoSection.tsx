...
function AboutusVideoSection({
  ...
  return (
    <div className="w-full h-[50vh] relative flex flex-col items-center justify-center gap-3">
      ...
      <div className="w-fit h-fit capitalize flex flex-col items-center justify-center gap-3 md:text-3xl lg:text-5xl text-2xl font-semibold text-graywhite z-[3] ">
