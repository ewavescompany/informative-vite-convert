  ...
  return (
    <div className="min-h-screen w-full h-full flex flex-col gap-10">
      <AboutusVideoSection
        ...
        descriptionAr="نحن نتخصص في تطوير الذكاء الاصطناعي والويب والموبايل، ونقدم حلول برمجية تقدم حلولًا مبتكرة يمكنها أن تؤدي إلى نمو الأعمال. نحن نهتم باستخدام التكنولوجيا المتقدمة لتحسين الوجود الرقمي وتسهيل استراتيجيات التسويق. نحن ملتزمون بمساعدة الشركات على التحول عبر حلول منطقية، مخصصة لاحتياجاتها."
      />
